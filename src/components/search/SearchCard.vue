...
<template>
  <v-card ref="cardRef" class="result-card" :class="{ 'tone-dark': isDarkCover, 'result-card--mobile-expanded': mobileExpanded }" variant="flat">
    ...
    >
      <CoverSurface :src="item.coverUrl" :alt="item.title" variant="card" class="cover-surface-host" @tone-change="handleToneChange" />
    </div>
...
.cover-surface-host :deep(.cover-surface__image .v-img__img),
.cover-surface-host :deep(.cover-surface__image .v-img__picture) {
...
.result-card:hover .cover-surface-host :deep(.cover-surface__image .v-img__img),
.result-card:focus-within .cover-surface-host :deep(.cover-surface__image .v-img__img),
.result-card:hover .cover-surface-host :deep(.cover-surface__image .v-img__picture),
.result-card:focus-within .cover-surface-host :deep(.cover-surface__image .v-img__picture) {
